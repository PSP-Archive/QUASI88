...
static int do_func( int func, int on )
{
  ...
  case FN_KETTEI:	return KEY88_KETTEI;	/* 決定 */
  case FN_HENKAN:	return KEY88_HENKAN;	/* 変換 */
  case FN_ZENKAKU:	return KEY88_ZENKAKU;	/* 全角 */
  case FN_PC:		return KEY88_PC;	/* ＰＣ */
