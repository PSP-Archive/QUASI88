...
{
  { { "  MONITOR  ",    " モニターモード ", }, DATA_TOP_MONITOR },
...
static const t_menudata data_cpu_clock[] =
{
  { { " [MHz] ",            " [MHz] "                                         }, -1                                  },
  { { " Set 4MHz ",         " 4MHzに設定 "                                    }, (int)(CONST_4MHZ_CLOCK * 1000000.0) },
  { { " Set 8MHz ",         " 8MHzに設定 "                                    }, (int)(CONST_8MHZ_CLOCK * 1000000.0) },
  { { "(Range= 0.1-100.0)", "（範囲は 0.1〜100.0、変更は直ちに反映されます）" }, -1                                  },
};
...
static const t_menulabel data_cpu_wait[] =
{
  ...
  { { " Rate of Speed ",  " 速度比 "                                      } },
  { { "[%]     ",         "[％]     "                                     } },
  { { "(Range= 5-5000) ", "（範囲は 5〜5000、変更は直ちに反映されます）"  } },
};
...
static const t_menulabel data_reset[] =
{
  ...
  { { " Setting ",                " 設定 "                         } },
  { { " Misc",                    " その他 "                       } },
  { { " * If you change the 'CPU CLOCK', you need to change the 'CPU-tag' setting. ",
      " ※ CPUクロックを変更する場合、CPUタブの設定も変更する必要があります。" } },
...
{
  { { "default       (function key)",        "default       標準 (ファンクションキー)",  },  FN_FUNC,        },
  ...
  { { "MOUSE-HIDE  : Hide Mouse",            "MOUSE-HIDE  : マウスを隠す",               },  FN_MOUSE_HIDE,  },
  ...
  { { "KETTEI      : KETTEI Key",            "KETTEI      : 決定 キー",                  },  FN_KETTEI,      },
  { { "HENKAN      : HENKAN Key",            "HENKAN      : 変換 キー",                  },  FN_HENKAN,      },
  { { "ZENKAKU     : ZENKAKU Key",           "ZENKAKU     : 全角 キー",                  },  FN_ZENKAKU,     },
  { { "PC          : PC Key",                "PC          : PC キー",                    },  FN_PC,          },
  { { "STOP        : STOP Key",              "STOP        : STOP キー",                  },  FN_STOP,        },
  { { "COPY        : COPY Key",              "COPY        : COPY キー",                  },  FN_COPY,        },
...
{
  { { " OK ",                                      " 確認 "                                               } },
  { { "File in DRIVE %d: / can't open the file.",  "ドライブ %d:／ファイルが開けません。"                 } },
				...
				Q8tkSignalFunc callback, void *parm )
{
  ...
  q8tk_signal_connect( combo, "changed", callback, parm );
...
/* キーアサイン変更用ウィジットを生成する ------------------------------
				XXXX
*/
INLINE	void	MAKE_KEY_COMBO( Q8tkWidget *box,
				const t_menudata *p,
				int (*f_initval)(int),
				Q8tkSignalFunc callback )
{
  ...
  }
  {
    ...
    q8tk_signal_connect( combo, "changed", callback, (void*)(p->val) );
